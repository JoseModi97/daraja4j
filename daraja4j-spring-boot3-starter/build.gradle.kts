...
description = "daraja4j auto-configuration for Spring Boot 3.x: a Daraja4jClient bean bound to " +
...
// raised above the daraja4j-core default of Java 8.
...
tasks.jar {
    manifest {
        attributes("Automatic-Module-Name" to "io.github.josemodi97.daraja4j.spring.boot3")
    }
}
