...
/**
 * Best-effort detection of which framework {@link Daraja4jInitMojo} should
 * scaffold an example for, based on the invoking project's declared
 * dependencies - used when {@code daraja4j.framework} is left at its default
 * of {@code auto} rather than set explicitly.
 *
 ...
 * in that case. Always logs what it found (or didn't) so the guess is never
 * silent - see {@link Daraja4jInitMojo#execute()}.
 */
