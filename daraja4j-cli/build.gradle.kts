...
description = "daraja4j command-line tool: trigger an STK push, poll transaction status, disburse " +
        "with B2C, reverse a transaction, check a balance, and parse captured callback payloads."

val mainClassName = "io.github.josemodi97.daraja4j.cli.Daraja4jCli"

dependencies {
    implementation(project(":daraja4j-core"))
...
tasks.shadowJar {
    manifest {
        attributes("Main-Class" to "io.github.josemodi97.daraja4j.cli.Daraja4jCli")
    }
}
...
tasks.jar {
    manifest {
        attributes(
            "Automatic-Module-Name" to "io.github.josemodi97.daraja4j.cli",
            "Main-Class" to "io.github.josemodi97.daraja4j.cli.Daraja4jCli"
        )
    }
}
