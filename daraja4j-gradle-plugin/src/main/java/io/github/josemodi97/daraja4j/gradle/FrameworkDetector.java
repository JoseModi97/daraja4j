...
/**
 * Best-effort detection of which framework {@link Daraja4jInitTask} should
 * scaffold an example for, based on the consumer project's declared
 ...
 * the guess is never silent - see {@link Daraja4jInitTask#run()}.
 *
