...
/** Daraja's synchronous acknowledgement of a {@link TransactionStatusRequest}. The actual status arrives at {@code resultUrl}. */
public final class TransactionStatusResult {
    ...
    private TransactionStatusResult(String conversationId, String originatorConversationId, String responseCode,
    ...
    public static TransactionStatusResult fromJson(String body) {
