...
/** Daraja's synchronous acknowledgement of a {@link ReversalRequest}. The actual reversal outcome arrives at {@code resultUrl}. */
public final class ReversalResult {
    ...
    private ReversalResult(String conversationId, String originatorConversationId, String responseCode,
    ...
    public static ReversalResult fromJson(String body) {
