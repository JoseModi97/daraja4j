...
/** Daraja's synchronous acknowledgement of a {@link B2cRequest}. The actual disbursement outcome arrives at {@code resultUrl}. */
public final class B2cResult {
    ...
    private B2cResult(String conversationId, String originatorConversationId, String responseCode,
    ...
    public static B2cResult fromJson(String body) {
